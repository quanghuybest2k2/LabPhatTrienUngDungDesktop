...
namespace Lab5_Demo
{
    public partial class MainForm : Form
    {
        ...
        private SinhVien GetSinhVien()
        {
            ...
            for (int i = 0; i < this.chklistboxMonDangKy.Items.Count; i++)
                if (chklistboxMonDangKy.GetItemChecked(i))
                    cn.Add(chklistboxMonDangKy.Items[i].ToString());
            sv.MonHoc = cn;
            return sv;
        }
        ...
        private void XoaForm()
        {
            ...
            rdNam.Checked = false;
            rdNu.Checked = false;
            for (int i = 0; i < chklistboxMonDangKy.Items.Count; i++)
                chklistboxMonDangKy.SetItemChecked(i, false);
        }
